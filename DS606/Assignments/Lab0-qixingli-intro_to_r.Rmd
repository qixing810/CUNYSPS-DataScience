...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
    ...
    **From the summary of the two data sets, we can clearly see that the *present* has much large 
    numbers of newborns.**
    ```{r}
...
-   Make a plot that displays the boy-to-girl ratio for every year in the data 
    ...
    **From the horizontal line in the plot below, we can see that the boy-to-girl ratio is greater 
    than 1 for all time.**
    ```{r}
